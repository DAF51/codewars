...
// you can use it or not use it, as you wish. Some people might prefer to reason with 
// content, some other with percentages only. It's up to you but you must keep it as a 
// parameter because the tests have it as an argument.

function evaporator(content, evap_per_day, threshold){ 
  let days = 0
  const evapPercent=evap_per_day/100
  const threshPer = threshold/100
  for(let i=1; i > threshPer; days++){
    i= i-(i*evapPercent)
  }
  return days
}
