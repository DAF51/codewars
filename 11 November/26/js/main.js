...
function warnTheSheep(queue) {
  let lastSpot = queue.length-1
  return queue[lastSpot] === "wolf"? "Pls go away and stop eating my sheep": `Oi! Sheep number ${Math.abs(queue.indexOf("wolf")+1-queue.length)}! You are about to be eaten by a wolf!`
}
