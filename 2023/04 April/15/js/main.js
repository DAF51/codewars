...
// cents per litre. But total discount per litre cannot be more than 25 cents. Return the total cost 
...
function fuelPrice(litres, pricePerLitre) {
  ...
  let price = litres*(pricePerLitre-discount)
