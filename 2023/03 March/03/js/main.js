...
// guessBlue() should return the probability of drawing a blue marble, expressed as 
// a float. For example, guessBlue(5, 5, 2, 3) should return 0.6.

function guessBlue(blueStart, redStart, bluePulled, redPulled) {
  const currentMarb = blueStart+redStart-bluePulled-redPulled
  const currentBlue = blueStart-bluePulled
  return currentBlue/currentMarb
}