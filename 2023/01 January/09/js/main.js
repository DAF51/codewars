...
// heterogametic and contain one of two types of sex chromosomes. They are 
// either X or Y. The female gametes or eggs however, contain only the X sex 
...
function chromosomeCheck(sperm) {
  return /[Y]/.test(sperm) ===true? "Congratulations! You're going to have a son.": "Congratulations! You're going to have a daughter."
}