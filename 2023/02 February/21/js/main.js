...
// animal which corresponds to the animal encountered by the frog. If this one is an alligator (case-insensitive)
//  return small otherwise return wide.

function mouthSize(animal) {
  const animalNorm = animal.toLowerCase()
  if(animalNorm === "alligator"){
    return "small"
  } else {
    return "wide"
  }
